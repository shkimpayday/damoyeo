      ...
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/groups/list" className="hover:text-white transition-colors">
                  모임 찾기
                </Link>
              </li>
              <li>
                <Link to="/groups/create" className="hover:text-white transition-colors">
                  모임 만들기
                </Link>
              </li>
              <li>
                <Link to="/meetings" className="hover:text-white transition-colors">
                  정모 일정
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/support/notice" className="hover:text-white transition-colors">
                  공지사항
                </Link>
              </li>
            </ul>
          ...
          {/* 정책 */}
          <div>
            <h3 className="text-white font-semibold mb-3">정책</h3>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <Link to="/policy/community" className="hover:text-white transition-colors">
                  커뮤니티 가이드
                </Link>
              </li>
            </ul>
          ...
          {/* 회사 */}
          <div>
            <h3 className="text-white font-semibold mb-3">회사</h3>
            <ul className="space-y-2 text-sm">
              <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-800 text-xs text-gray-500">
            <p>© {currentYear} 다모여. All rights reserved.</p>
            <p className="mt-1">
              사업자등록번호: 000-00-00000 | 대표: 홍길동 | 주소: 서울특별시 강남구
            </p>
          </div>
        </div>
      </div>
